...
As well as being able to contact me via [email](mailto:drandrewjstewart@gmail.com) you can also contact me via our dedicated Slack channel. You can subscribe to this channel simply by clicking on [this link](https://join.slack.com/t/andrew-open-research/shared_invite/zt-fdaqq2y9-Qd2avTuxi2rIrM1psTjMIA). You can install the Slack app on your computer or phone - I recommend you do this as interacting with Slack via the app is really great. 

You can speak to me in one of the timetabled Zoom sessions I have set up - or via a personal meeting request - just ping me via email or Slack to request that. Additionally, you can follow me on [Twitter](https://twitter.com/ajstewart_lang?lang=en) where you'll see me tweet and re-tweet lots of Open Research and R content.
